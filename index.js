...
Currently, ${listOfUnfundedGames.length > 0 ? listOfUnfundedGames.length : "0"} games are still unfunded. 
...
firstGameElement.innerHTML = `Top Game: ${topGame.name}`;
firstGameContainer.appendChild(firstGameElement);

// do the same for the runner up item
const secondGameElement = document.createElement("p");
secondGameElement.innerHTML = `Runner-Up: ${runnerUpGame.name}`;
